...
class PS4TeleopNode(Node):
    ...
    - T hold -> engine start (publish /engine_start)
    """
    def __init__(self):
        ...
        self.engine_pub = self.create_publisher(Bool, '/engine_start', 10)
        ...
        self.get_logger().info(
            ...
            f"T hold in power mode -> Engine start."
        )
